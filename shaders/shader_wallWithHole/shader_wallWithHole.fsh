...
void main()
{
	// Why... GM pls
	int test[64];
	test[0] = 0; test[1] = 48; test[2] = 12; test[3] = 60; test[4] = 3; test[5] = 51; test[6] = 15; test[7] = 63;
	...
	test[32] = 2; test[33] = 50; test[34] = 14; test[35] = 62; test[36] = 1; test[37] = 49; test[38] = 13; test[39] = 61;
	...
	vec2 pixel = normalizedUv * u_size * 0.25;
