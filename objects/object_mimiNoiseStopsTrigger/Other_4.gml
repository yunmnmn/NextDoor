...
{		
	...
	cb9_4 = function()
	{
		...
		c9_4.AddSubText(new SubText("Oh well, I can finally do some studying.", 0.3, true));
		RenderText(c9_4);
	}
	...
	cb9_3 = function()
	{
		...
		c9_3.AddSubText(new SubText("After all that trouble he gave me...", 0.3, true));
		RenderText(c9_3);
	}
	...
	cb9_2 = function()
	{
		...
		c9_2.AddSubText(new SubText("What happened?", 0.4, true));
		RenderText(c9_2);
	}
