...
{		
	...
	cb9_4 = function()
	{
		...
		c9_4.AddSubText(new SubText("Oh well, I can finally do some studying", 0.2));
		RenderText(c9_4);
	}
	...
	cb9_3 = function()
	{
		...
		c9_3.AddSubText(new SubText("After all that trouble he gave me", 0.2));
		RenderText(c9_3);
	}
...
function MimiNoticesMusicStopped()
{
