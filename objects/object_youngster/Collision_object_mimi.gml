...
function MimiAndYoungsterConversation()
{
	...
	cb4_8 = function()
	{
		var c2_8 = new TextContext(sprite_youngsterAvatarNormal, conversationFinished);
	...
	cb4_7 = function()
	{
		var c2_7 = new TextContext(sprite_youngsterAvatarNormal, cb4_8);
	...
	cb4_6 = function()
	{
		var c2_6 = new TextContext(sprite_youngsterAvatarNormal, cb4_7);
	...
	cb4_5 = function()
	{
		var c2_5 = new TextContext(sprite_mimiAvatarAngry, cb4_6);
	...
	cb4_4 = function()
	{
		var c2_4 = new TextContext(sprite_mimiAvatarTroubled, cb4_5);
	...
	cb4_3 = function()
	{
		var c2_3 = new TextContext(sprite_mimiAvatarTroubled, cb4_4);
	...
	cb4_2 = function()
	{
		var c4_2 = new TextContext(sprite_youngsterAvatarSmirk, cb4_3);
		c4_2.AddSubText(new SubText("That neighbour seems to be away a lot", 0.2));
		RenderText(c4_2);
	}
	
	// Call the parent text context
	var c4_1 = new TextContext(sprite_youngsterAvatarNormal, cb4_2);
